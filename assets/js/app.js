...
const salju = document.querySelector(".salju");
salju.addEventListener("click", () => {
    document.querySelector(".snowflakes").classList.toggle("oPEn");
})

const nv = document.querySelector(".nv");
nv.addEventListener("click", () => {
    document.querySelector(".nav__menu").classList.toggle("open-8");
})

const toggleaBtn1 = document.querySelector(".togglea");

toggleaBtn1.addEventListener("click", () => toggleaBtn1.classList.toggle("aCtive-00"));
